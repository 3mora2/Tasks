...
book = load_workbook('url_ele.xlsx')
sheet = book.active
...
if not os.path.exists(path):
    ...
    if len(os.listdir('PDF'))>0:
        ...
        p=1
        Categorys=[1,0,0,0,0]
#1740_1 - Antioquia (100.00%)_1 - Medellin_ZONA 15_06 - SEC.ESC.NIÑO JESUS DE PRAGA_Mesa 001
p=1740#int(Categorys[0])+len(f_f) if int(Categorys[0]) != 1 else int(Categorys[0])      
c_m='1 - Antioquia (100.00%)'#Categorys[1]
c_1='1 - Medellin'#Categorys[2]
c_2='ZONA 15'#Categorys[3]
c_3='06 - SEC.ESC.NIÑO JESUS DE PRAGA'#Categorys[4]
                ...
                for cate_3 in category_3[n3:]:
                    ...
                    for i in pdf:
                        if '.pdf' in i.get_attribute('href'):
                            ...
                            sheet[f'A{p}'] = i.get_attribute('href')
                            sheet[f'B{p}'] = name
                            book.save('url_ele.xlsx')
                            """try:

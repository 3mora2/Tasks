...
book = load_workbook('مدارس-مدينة-الجيزة-خاصة.xlsx')
sheet = book.active
num = 1
...
sheet[f'J{num}'].value = "المميزات"
sheet[f'K{num}'].value = "الصور"
for num in range(2, sheet.max_row + 1):
    try:
        ...
        try:
            mom = driver.find_element_by_css_selector('.additional-amenities').text
        except:
            mom = None
        ...
        sheet[f'J{num}'].value = mom
        sheet[f'K{num}'].value = img
    except:
        pass
book.save('مدارس-مدينة-الجيزة-خاصة.xlsx')
...
# while i != 23:
#     driver.get(
#         f'https://madaresegypt.com/ar/Results/%D9%85%D8%AF%D8%A7%D8%B1%D8%B3/%D9%85%D8%AF%D9%8A%D9%86%D8%A9-%D8%A7%D9%84%D8%AC%D9%8A%D8%B2%D8%A9/%D8%AE%D8%A7%D8%B5%D8%A9?page={i}')
#     for el in driver.find_elements_by_css_selector('div.block-heading > h4 > a'):
#         sheet[f'Z{n}'] = el.get_attribute("href")
#         n += 1
#     print(n)
#     i += 1
# book.save("مدارس-مدينة-الجيزة-خاصة.xlsx")

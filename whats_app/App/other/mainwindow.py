...
"color: rgb(0, 0, 0);")
        ...
        self.pushButton_57.setStyleSheet(u"background-color: rgb(255, 255, 255, 0);")
        icon = QIcon()
        icon.addFile(u":/newPrefix/pnghut_whatsapp-message-icon-logo-whatsapp.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_57.setIcon(icon)
        self.pushButton_57.setIconSize(QSize(78, 87))

        self.gridLayout_39.addWidget(self.pushButton_57, 0, 0, 1, 1)

        self.label_5 = QLabel(self.frame_32)
        ...
        self.label_5.setTextInteractionFlags(Qt.LinksAccessibleByMouse|Qt.TextSelectableByKeyboard|Qt.TextSelectableByMouse)

        self.gridLayout_39.addWidget(self.label_5, 1, 0, 1, 2)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"+966551326563", None))

...
class SouCode:
    ...
    def __init__(self, file_name):
        ...
        try:
            ...
            len_ = [self.sheet[f'A{el}'].value for el in range(2, end_cell + 1) if
                    self.sheet[f'A{el}'].value is not None]
            len_ok = [self.sheet[f'A{el}'].value for el in range(2, end_cell + 1) if
                      self.sheet[f'AA{el}'].value == 'OK' and self.sheet[f'A{el}'].value is not None]
            if len(len_ok) == len(len_):
                for ii in range(2, end_cell + 1):
                    self.sheet[f'AA{ii}'].value = None
    ...
    def Search(self):
        ...
        for i in range(2, end_cell + 1):
            ...
            print(self.sheet[f'AA{i}'])
            self.sheet[f'AA{i}'] = 'OK'
            self.book.save(file)
            #########################################
...
if __name__ == "__main__":
    pass
    file = input('Enter file name, like TEST.xlsx : ').strip()  # 'TEST.xlsx'
    email = input('Enter your email : ')  # 'mohabamr157@gmail.com'
    password = input('Enter your password : ')  # 'NewEra2020'
    ...
    main_seller = input('Main seller : ')  # 'Infinity'
    percent = float(input('Enter percent : '))  # 160

    ...
    def search_bar(self, code):
        ...
        while True:
            if len(self.driver.find_elements_by_css_selector('.sc-dkmKpi.lpsTSO')) > 0:
                ...
                break
            if code in WebDriverWait(self.driver, 5).until(ec.presence_of_element_located(
        ...
        for i in range(2, end_cell + 1):
            ...
            try:
                ...
                if not data['props']['pageProps']['catalog']['product']['variants'][0]['offers']:
                    ...
                    print(' No Offers. So, maximum price is ', max_pr)
                    Note = ' No Offers. So, maximum price is ' + str(max_pr)
                    ...
                    if main_seller in seller:
                        ...
                        max_f = True
                        only = 'No'
                        Note = ' express. So, maximum price is ' + str(max_pr)
                        static = 'Maximum Price Express'
